...
public class SoldierServerAvatar extends AbstractServerAvatar implements IDebrisTexture {
	...
	public SoldierServerAvatar(MoonbaseAssaultServer _module, ClientData client, IInputDevice _input, int eid) {
		super(_module, MoonbaseAssaultClientEntityCreator.SOLDIER_AVATAR, client, _input, eid, new SoldierModel(_module.getAssetManager(), -1, true, true), MoonbaseAssaultGlobals.MAX_HEALTH, MoonbaseAssaultGlobals.PRI_PLAYER, new PersonAvatar(_module, _input, MoonbaseAssaultGlobals.MOVE_SPEED, MoonbaseAssaultGlobals.JUMP_FORCE));

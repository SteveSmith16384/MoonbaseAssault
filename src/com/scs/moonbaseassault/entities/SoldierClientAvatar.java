...
public class SoldierClientAvatar extends AbstractClientAvatar {
	...
	public SoldierClientAvatar(AbstractGameClient _module, int _playerID, IInputDevice _input, Camera _cam, int eid, float x, float y, float z, byte side) {
		super(_module, MoonbaseAssaultClientEntityCreator.SOLDIER_AVATAR, _playerID, _input, _cam, eid, x, y, z, side, new SoldierModel(_module.getAssetManager(), side, true, true), new PersonAvatarControl(_module, _input, MoonbaseAssaultGlobals.MOVE_SPEED, MoonbaseAssaultGlobals.JUMP_FORCE));
	}
